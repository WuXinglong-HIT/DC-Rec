...
parser.add_argument('--dataset', default='RetailRocket', help='diginetica/Tmall/Nowplaying/yoochoose1_64/RetailRocket')
...
pickle.dump(adj, open( dataset + '/adj_' + str(sample_num) + '.pkl', 'wb'))
pickle.dump(weight, open( dataset + '/num_' + str(sample_num) + '.pkl', 'wb'))
